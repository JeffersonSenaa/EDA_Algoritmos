...
int main(){
    ...
    fpNovo = fopen("AirlinesOrdenado.csv", "w");     //Função para abrir o arquivo
    ...
    int medias[] = {medCO, medMQ, medAA, medWN, med9E, medOO, medAS, medHA, medDL, medF9, medEV, medUA, medFL, medUS, medOH, medXE, medYV, medB6};
